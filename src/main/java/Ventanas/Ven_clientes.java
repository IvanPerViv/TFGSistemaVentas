...
public class Ven_clientes extends javax.swing.JInternalFrame {
    ...
    protected void cargaDeDatosClientes(String buscar) {
        String[] nombreTablas = {"Codigo", "Nombre", "Apellidos", "Telefono", "CP", "Dirreción", "Ciudad", "Email"}; //Cargamos en un array el nombre que tendran nuestras columnas.
        ...
        for(int i = 0; i < clieArray.size(); i++){
            ...
            fila[2] = clieArray.get(i).getApellidos();
            fila[3] = clieArray.get(i).getTelefono();
            fila[4] = clieArray.get(i).getCodigo_postal();
            fila[5] = clieArray.get(i).getDirrecion();
            fila[6] = clieArray.get(i).getCiudad();
            fila[7] = clieArray.get(i).getEmail();
    ...
    private void initComponents() {
        ...
        setMaximumSize(null);
        setMinimumSize(null);
        setPreferredSize(new java.awt.Dimension(581, 632));
    ...
    private void botonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGuardarActionPerformed
        ...
        boolean comprobacion = objConexionClientes.ingresoClientes(codigoUser, nombre, apellidos, telefono, cod_postal, dirrecion, ciudad, email);
    ...
    private void botonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActualizarActionPerformed
        //BOTON MODIFICAR
        bloquearBotones(true);
        boolean comprobacion = objConexionClientes.actualizarClientes(Integer.parseInt(TFCodigo.getText()), TFNombre.getText(), TFApellidos.getText(), TFTelef.getText(), TFCp.getText(), TFDir.getText(), TFCiudad.getText(), TFEmail.getText());
